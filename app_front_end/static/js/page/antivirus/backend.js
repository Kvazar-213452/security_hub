            ...
            for (let i = 0; i < detected_viruses.length; i++) {
                $("#ump_u3fgbbb_1_1").append(`
                    <div class="div_pdq32fwesd">
                        ...
                        <button onclick="window.backend.del_file_scan(${i})" class="po12ldqwecsdbgb">Видалити</button>
                    </div>
                `);
            }
        } else if (this.lang_global === "en") {
            for (let i = 0; i < detected_viruses.length; i++) {
                $("#ump_u3fgbbb_1_1").append(`
                    <div class="div_pdq32fwesd">
                        <p class="iewfv2222c">${detected_viruses[i]['path']}</p>
                        <p class="iewfv2222c1">${detected_viruses[i]['hash']}</p>
                        <button onclick="window.backend.del_file_scan(${i})" class="po12ldqwecsdbgb">Remove</button>
                    </div>
                `);
            }
        }
