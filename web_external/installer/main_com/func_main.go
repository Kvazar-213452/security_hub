...
func DWN_app() {
	directory := "C:/security_hub"

	os.MkdirAll(directory, 0755)

	url := "https://raw.githubusercontent.com/Kvazar-213452/security_hub/refs/heads/main/web_external/data/main.zip"
	outputPath := filepath.Join("C:", "security_hub", "main.zip")
...
func create_lnk() {
	...
	targetPath := "C:\\security_hub\\main.exe"
	workingDirectory := "C:\\security_hub"
