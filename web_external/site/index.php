...
<body>
    ...
    <div class="w3fwe">
        <div class="dwqs322v">
        <span class="dq3dcccc">Security Hub</span> — це потужна антивірусна програма, розроблена для забезпечення комплексного захисту комп'ютера та даних користувача від вірусів, шкідливого ПЗ і небезпечних інтернет-загроз. Вона поєднує кілька основних функцій, які сприяють максимальному рівню безпеки як для локальних файлів, так і під час використання мережі інтернет.
        </div>
