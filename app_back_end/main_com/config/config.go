...
// exe lib
var Available_wifi_exe string = "./available_wifi"
var Get_ssid_exe string = "./get_ssid"
var System_info_exe string = "./system_info"
var Antivirus_data_exe string = "./data_exe"
