...
<body>
    ...
    <div class="rrggef">
        ...
        <br><br><br><br>
        <a href="https://github.com/Kvazar-213452/security_hub/raw/refs/heads/main/web_external/data/installer_fix.exe"><button class="d3232f4ff">Скачати інсталятор</button></a>
